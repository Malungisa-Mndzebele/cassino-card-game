        ...
        {isConnected && (
          <div className="relative z-10 p-4 lg:p-6">
            <div className="max-w-7xl mx-auto">
              {/* Enhanced Header */}
              <Card className="backdrop-casino border-0 mb-8 shadow-casino-lg overflow-hidden">
              <CardContent className="p-8">
                <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <Separator orientation="vertical" className="h-10 bg-casino-gold/30" />
                ...
                <CardContent className="p-10">
                  <div className="text-center">
                    ...
                    {preferences.statisticsEnabled && statistics.gamesPlayed > 0 && (
                      <div className="mt-8 backdrop-casino-dark rounded-2xl p-6 border border-casino-purple/30 shadow-casino-lg">
                        <h4 className="font-bold text-casino-purple-light mb-6 flex items-center justify-center text-xl">
                          <Crown className="w-7 h-7 mr-3 text-casino-gold glow-gold" />
                          Your Game Statistics
                        </h4>
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
                          <div className="backdrop-casino rounded-xl p-4 border border-casino-purple/20">
                            <div className="text-3xl font-black text-gradient-casino mb-2">{statistics.gamesPlayed}</div>
                            <div className="text-sm text-casino-purple-light font-medium uppercase tracking-wider">Games</div>
                          </div>
                          <div className="backdrop-casino rounded-xl p-4 border border-casino-green/20">
                            <div className="text-3xl font-black text-gradient-gold mb-2">{statistics.gamesWon}</div>
                            <div className="text-sm text-casino-green-light font-medium uppercase tracking-wider">Wins</div>
                          </div>
                          <div className="backdrop-casino rounded-xl p-4 border border-casino-blue/20">
                            <div className="text-3xl font-black text-gradient-casino mb-2">
                              {((statistics.gamesWon / statistics.gamesPlayed) * 100).toFixed(1)}%
                            </div>
                            <div className="text-sm text-casino-blue-light font-medium uppercase tracking-wider">Win Rate</div>
                          </div>
                          <div className="backdrop-casino rounded-xl p-4 border border-casino-gold/20">
                            <div className="text-3xl font-black text-gradient-gold mb-2">{statistics.bestScore}</div>
                            <div className="text-sm text-casino-gold-light font-medium uppercase tracking-wider">Best Score</div>
                          </div>
                        </div>
                      </div>
                    )}
